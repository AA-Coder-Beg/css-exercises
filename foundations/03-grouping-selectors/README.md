...
### Self Check
- Does each element have a unique class name? [X] Yes || [] No
- Did you use the grouping selector for styles that both elements share? [X] Yes || [] No
- Did you make separate rules for the styles unique to each element? [X] Yes || [] No
