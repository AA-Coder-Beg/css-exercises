...
### Self Check
- Did you properly chain class selectors for each rule? [X] Yes || [] No
- Does the `proportioned` image retain its original square proportions? [X] Yes || [] No
- Does the `distorted` image end up looking squished and, well, distorted? [X] Yes || [] No
